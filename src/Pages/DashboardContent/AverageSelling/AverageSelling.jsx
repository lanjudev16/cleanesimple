...
import { FaAdversal, FaDollarSign } from "react-icons/fa";
import {
  BarChart,
  Bar,
  Tooltip,
  ...
  return (
    <div className="flex flex-col gap-4 items-center mt-[24px] p-[20px] rounded  bg-[#2F3349]">
      <div className="flex items-center justify-center">
        ...
        <h2 className="text-[#A2A6C1] text-2xl font-medium ">Average Selling</h2>
      </div>
      ...
      <div className="grid lg:grid-cols-5">
        <div className="col-span-3 text-[#A2A6C1] text-[16px]">
          <h1>$ 431.00</h1>
          <p>
            <span className="text-red-300">+1.5%</span> from the last week
          </p>
        </div>
